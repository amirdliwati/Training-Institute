...
<div class="form">
    ...
    <div class="form-group has-feedback">
        <?php echo $form->labelEx($model, 'num', array('class' => 'col-md-5 control-label')); ?>
    ...
    <div class="form-group has-feedback">
        <?php echo $form->labelEx($model, 'date', array('class' => 'col-md-5 control-label')); ?>
        <div class="col-md-7 input-container">
    ...
    <div class="form-group has-feedback">
        <?php echo $form->labelEx($model, 'start_date', array('class' => 'col-md-5 control-label')); ?>
        <div class="col-md-7 input-container">
    ...
    <div class="form-group has-feedback">
        <?php echo $form->labelEx($model, 'end_date', array('class' => 'col-md-5 control-label')); ?>
        <div class="col-md-7 input-container">
    ...
    <div class="form-group">
        <div class="col-sm-offset-4 col-sm-6">
            <?php echo CHtml::ajaxSubmitButton('تعديل بيانات اللائحة', $this->createUrl('update', array('id' => $model->id)), array(
                'type' => 'POST',
                'dataType' => 'json',
                ...
                'beforeSend'=>'js:function(){
                    ...
                    $("#filterPleaseWaitModal .modal-body").html("الرجاء الانتظار ريثما يتم التعديل...");
